...
>
    <button
        ...
        <div x-show='uploading' class="media-library-progress-wrap media-library-progress-wrap-loading">
            <progress max="100" x-bind:value="progress" class="media-library-progress"></progress>
        </div>
